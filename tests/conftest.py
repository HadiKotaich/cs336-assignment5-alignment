...
def model_id():
    """
    with-proxy uv run huggingface-cli download Qwen/Qwen2.5-Math-1.5B --local-dir /data/users/hadikotaich/cs336-assignment5-alignment/models/Qwen2.5-Math-1.5B
    """
    return (
